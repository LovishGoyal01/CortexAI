...
const Sidebar = () => {
    ...
    if(collapsed){
      return(
        <div
        className="hidden lg:flex flex-col items-center w-[56px] h-screen
    ...
    >
       ...
       <div className='flex flex-col h-full'>
          ...
          <div className='px-4 pt-4 pb-1'>
              ...
              text-white bg-linear-to-br from-indigo-500 to-violet-700 rounded-xl py-[10px] 
          ...
          {conversations.length == 0 ? <div className='px-5 pt-4 pb-1.5 text-[10.5px] font-semibold 
          uppercase tracking-widest text-slate-600'>
             NO Recent Conversations
           </div> : (
           <div className='px-5 pt-4 pb-1.5 text-[10.5px] font-semibold 
            uppercase tracking-widest text-slate-600'>
                Recent
           </div>  
          )}
          ...
          <div className="px-3.5 py-3.5">
            {userData ? (
             ...
             rounded-xl py-[11px] cursor-pointer hover:bg-white/[0.08] transition-colors duration-150"
             >
              Login
             </button>
            )}
